...
instr = visual.TextStim(win=win, name='instr',
    text='svar!',
    font='Arial',
    pos=[0, 0.8], height=0.3, wrapWidth=None, ori=0, 
    color='white', colorSpace='rgb', opacity=1,
    depth=-1.0);
...
fixationComponents = [polygon_2, skipFIX]
...
trials = data.TrialHandler(nReps=1, method='sequential', 
    ...
    trialList=data.importConditions('IOstim-2017-02-01.xlsx'),
